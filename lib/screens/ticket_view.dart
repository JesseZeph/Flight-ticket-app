...
class TicketView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      height: AppLayout.getHeight(GetPlatform.isAndroid == true ? 169 : 169),
      child: Container(
        ...
        child: Column(
          ...
          children: [
            /*
              SHOWING THE PURPLE PART OF THE CARD TICKET
              */
            Container(
              decoration: BoxDecoration(
                color: isColor == null ? Color(0xFF8E24AA) : Colors.white,
            ...
            /* 
              SHOWING THE Pink PART OF CART TICKET
              */
            Container(
              color: isColor == null ? Styles.pinkColor : Colors.white,
              child: Row(
                children: [
                  SizedBox(
